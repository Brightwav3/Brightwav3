...
<p align="center"> Building modular AI systems, developer infrastructure, and local-first software designed to outlive any single model or interface. </p>
<p align="center">
...
<p align="center"> Instead of treating an assistant as a single application, Jarvis separates capabilities into independent components with explicit contracts between them.</p>
